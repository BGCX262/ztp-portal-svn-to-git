...
public class InfoCommentList extends CorePage {
	...
	public InfoCommentList(Information information) {
	...
	private ListView getCommentListView(final Information information) {

		commentListView = new PageableListView("commentListView",
				commentController.getActiveInformationComment(information), 20) {
	...
	private class CommentForm extends Form{
		...
		public CommentForm(String id, final Information information) {
			super(id);
