...
public class PictureUpload extends CorePage {
	...
	private class FileUploadForm extends Form {
		 ...
		 *            Component name
		 */
		public FileUploadForm(String name, Living living) {
			super(name);
		...
		protected void onSubmit() {
			...
			while (it.hasNext()) {
				...
				try {
					...
					picture.setOwner(living.getOwner());
					picture.setLiving(living);
					...
					feedbackModalPanel
							.info("Vöetky s˙bory boli uloûenÈ. MÙûete ukonËiù vkladanie.");
	...
	public FileUploadForm getFileUploadForm(Living living,
	...
	private Folder getUploadFolder() {
		...
		Folder uploadFolder = new Folder("wicketTEMP");// new
