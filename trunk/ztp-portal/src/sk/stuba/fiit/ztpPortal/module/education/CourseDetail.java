...
public class CourseDetail extends CorePage{
	...
	public CourseDetail(){
		...
		add(new CourseDetailForm("courseDetailForm"));
	}
	...
	public final class CourseDetailForm extends Form {
		...
		public CourseDetailForm(final String id) {
			super(id);

			courseType = new DropDownChoice("courseType", new PropertyModel(
					properties, "courseType"), COURSETYPE_LIST);
		...
		protected void onSubmit() {
			try {
				...
				if (courseController.saveNewCourse(course)){
